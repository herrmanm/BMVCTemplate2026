...
\begin{figure}[h]
    ...
    \caption{XXSchematic diagram. Camera data is analyzed using AI nodes and fed into the simulation. Changes made there are analyzed and synchronized in the real-world system.XX workspace matching -> synchronization}
    \label{fig:schematic}
\end{figure}
